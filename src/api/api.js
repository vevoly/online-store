...
export const getCategory = params => {
  if('id' in params){
    return axios.get(`${localhost}/goodsCategorys/`+params.id+'/');
  }
  else {
    return axios.get(`${localhost}/goodsCategorys/`, params);
  }
};

//获取分类价格区间
export const getSearchPriceRange = params => { return axios.get(`${localhost}/priceRange/`, {params: params})}
...
//短信
export const getMessage = parmas => { return axios.post(`${localhost}/smscodes/`, parmas) }
